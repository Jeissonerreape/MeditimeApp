...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final PatternLibraryAccessors laccForPatternLibraryAccessors = new PatternLibraryAccessors(owner);
    private final PdfviewLibraryAccessors laccForPdfviewLibraryAccessors = new PdfviewLibraryAccessors(owner);
    private final PlayLibraryAccessors laccForPlayLibraryAccessors = new PlayLibraryAccessors(owner);
    private final RecaptchaLibraryAccessors laccForRecaptchaLibraryAccessors = new RecaptchaLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>androidpdfviewer</b> with <b>com.github.DImuthuUpe:AndroidPdfViewer</b> coordinates and
     * with version reference <b>androidpdfviewerVersion</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getAndroidpdfviewer() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("androidpdfviewer");
    }
    ...
    /**
     * Dependency provider for <b>fancytoast</b> with <b>io.github.shashank02051997:FancyToast</b> coordinates and
     * with version reference <b>fancytoast</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getFancytoast() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("fancytoast");
    }
    ...
    /**
     * Group of libraries at <b>pattern</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public PatternLibraryAccessors getPattern() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForPatternLibraryAccessors;
    }

    /**
     * Group of libraries at <b>pdfview</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public PdfviewLibraryAccessors getPdfview() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForPdfviewLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>recaptcha</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public RecaptchaLibraryAccessors getRecaptcha() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForRecaptchaLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class PatternLibraryAccessors extends SubDependencyFactory {

        public PatternLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>lock</b> with <b>io.github.itsxtt:pattern-lock</b> coordinates and
         * with version reference <b>patternLock</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getLock() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("pattern.lock");
        }
     ...
     */
    @Deprecated
    public static class PdfviewLibraryAccessors extends SubDependencyFactory {

        public PdfviewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.dmitryborodin:pdfview-android</b> coordinates and
         * with version reference <b>pdfviewAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class RecaptchaLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public RecaptchaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>recaptcha</b> with <b>com.google.android.recaptcha:recaptcha</b> coordinates and
         * with version reference <b>recaptcha</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("recaptcha");
        }

        /**
         * Dependency provider for <b>v1870</b> with <b>com.google.android.recaptcha:recaptcha</b> coordinates and
         * with version reference <b>recaptchaVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV1870() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("recaptcha.v1870");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidpdfviewerVersion</b> with value <b>3.1.0-beta.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidpdfviewerVersion() { return getVersion("androidpdfviewerVersion"); }
        ...
        /**
         * Version alias <b>fancytoast</b> with value <b>2.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFancytoast() { return getVersion("fancytoast"); }
        ...
        /**
         * Version alias <b>navigationFragment</b> with value <b>2.8.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationUi</b> with value <b>2.8.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>patternLock</b> with value <b>0.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPatternLock() { return getVersion("patternLock"); }

        /**
         * Version alias <b>pdfviewAndroid</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPdfviewAndroid() { return getVersion("pdfviewAndroid"); }
        ...
        /**
         * Version alias <b>recaptcha</b> with value <b>18.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRecaptcha() { return getVersion("recaptcha"); }

        /**
         * Version alias <b>recaptchaVersion</b> with value <b>18.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRecaptchaVersion() { return getVersion("recaptchaVersion"); }
